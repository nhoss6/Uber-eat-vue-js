...
export default {
    ...
    setup() {
        ...
        // onMounted sert à voir si tous les composant sont bien chargés 
...
.home {
    ...
    .bannier {
        height: 200px;
        width: 100%;
        background-image: url("https://d1b3667xvzs6rz.cloudfront.net/2019/09/Uber-Eats-.png");
